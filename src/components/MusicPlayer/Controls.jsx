...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setShuffle, currentSongs, handlePlayPause, handlePrevSong, handleNextSong }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    {isPlaying ? (
      <BsFillPauseFill size={50} color="#FFF" onClick={handlePlayPause} className="cursor-pointer bg-[#F51E384D] rounded-3xl p-2" />
    ) : (
      <BsFillPlayFill size={50} color="#FFF"   onClick={handlePlayPause} className="cursor-pointer bg-[#F51E384D] rounded-3xl p-2" />
    )}
